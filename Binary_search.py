...
print(f"Time taken by iterative Binary search = {time_taken} seconds")
...
print(f"Time taken by recursive Binary Search : {time_recursive} seconds")
...
print(f"Time taken by Linear search :  {time_linear} seconds")
